    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="absolute top-1 right-1 z-10 rounded-full bg-muted text-white hover:bg-muted"
            onClick={onRemove}
    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="ml-2 self-start rounded-full bg-muted p-1 text-teal-700 hover:bg-muted"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="ml-2 rounded-full bg-muted p-1 text-muted-foreground hover:bg-muted"
          onClick={onRemove}
